...
| Wave | Theme | Items |
|---|---|---|
| **W1** | Schema integrity (correctness) | export_jobs uniqueness, idempotency_keys CHECK+updated_at, distributed_locks lease CHECK, usage_records per-partition request_id uniqueness |
