...
- **Execution plane** → **Stage 12** (runtime infrastructure, frozen), **Stage 13**
  ...
  **Stage 20** (the α9.2 media library — the real `LibraryRepository` + `library.*` use cases
  ...
  and **Stage 21** (the α9.3 publish thumbnail support — an owned image carried through
...
owner-scoped bounded context sibling to the Media aggregate — earns its own **Stage 20**; and
the α9.3 publish thumbnail support — an additive, best-effort extension of the Publishing plane
(a new destination-delivery artifact) — earns its own **Stage 21**
(current baseline `v0.4.46-phase3-alpha9.3`).
