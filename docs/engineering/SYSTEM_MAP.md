...
**Stage 22**; and the α9.5 notification email delivery — a new **outbound external channel** driven by
its own dedicated leased worker (not the relay) — earns its own **Stage 23**
(current baseline `v0.4.48-phase3-alpha9.5`).
