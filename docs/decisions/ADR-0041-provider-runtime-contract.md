...
| Notifications (in-app projection) | ✅ **α8.5b.3** | `NotificationProjection` (2nd relay consumer) on `ExportJobSucceeded`/`ExportJobFailed`; exactly-once per recipient per source event (DB-enforced); read API **α8.5b.3r**, email **α8.5b.4** |
