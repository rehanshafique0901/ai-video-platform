...
| **α8.5b** | Publishing + storage providers + download service | publishing/notifications, `IObjectStorage` cloud backends (S3/R2/GCS, CR-5), download-serving endpoints + CDN — ADR-0041 D12 | none |
