...
| **α8.4e** | Render composition enhancements | audio mixing / transitions & effects (α6.4 write paths first) / FFmpeg quality tuning — changes *what the render is* (`IRenderer`/Timeline→Video), ADR-0041 D12 | none |
