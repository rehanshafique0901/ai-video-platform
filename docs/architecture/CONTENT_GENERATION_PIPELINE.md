...
| **α8.4d** | Render/media enhancements | previews / GIF previews / waveform / audio mixing / transitions & effects (α6.4 write paths first) / FFmpeg quality tuning — ADR-0041 D12 | none |
