...
| **α8.4c** | Render enhancements | thumbnails / waveform / audio mixing / transitions & effects (α6.4 write paths first) / duration-dimensions-codec enrichment / previews on generated media — ADR-0041 D12 | none |
